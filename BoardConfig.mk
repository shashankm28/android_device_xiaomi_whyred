...
TARGET_BOARD_COMMON_PATH := device/xiaomi/whyred/sdm660
...
BOARD_PREBUILT_DTBOIMAGE := device/xiaomi/whyred-kernel/dtbo.img
...
TARGET_RECOVERY_WIPE := device/xiaomi/whyred/recovery.wipe
TARGET_RECOVERY_FSTAB := device/xiaomi/whyred/fstab.hardware
